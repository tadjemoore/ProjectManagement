class NavigationController {
    ...
    bindModalEvents() {
        ...
        // Close calendar modals when clicking outside the modal content
        [this.view.calendarProjectDetailModal, this.view.calendarTaskDetailModal, this.view.calendarDayDetailModal]
            .filter(Boolean)
            .forEach(modal => {
